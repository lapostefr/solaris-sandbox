import{r,w as u}from"./vue.esm-bundler-DD7xIM0D.js";const i={title:"Organisms/Style Switcher",argTypes:{},args:{}},s={render:e=>({setup(){const o=r(e.show),w=r(e.show2),h=r(e.show3);return u(()=>e.value,c=>{o.value=c}),{args:e,show:o,show2:w,show3:h}},template:`
    <div>
